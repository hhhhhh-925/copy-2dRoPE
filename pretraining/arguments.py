...
class Args(Tap):
    ...
    reverse_dataset_order: int = 0
    '''
    If 1, load DCLM shards in reverse order and on resume do not skip dataloader batches
    (see trainer.handle_resumption); still sets the step counter to resume_step.
    '''
    ...
    n_validation_examples: int | None = None
